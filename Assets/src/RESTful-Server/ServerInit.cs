...
public class ServerInit : MonoBehaviour 
{
	...
	void Start () {
		...
		routingManager.AddRoute(new Route(Route.Type.POST, "/stats/{count}", "StatsInvoke.SetBuildingCount"));
        routingManager.AddRoute(new Route(Route.Type.GET, "/stats/{count}", "StatsInvoke.GetStats"));
